...
@app.on_message(filters.command(["xgban", "xglobalban"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["xungban"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["xgbannedusers", "xgbanlist"]) & SUDOERS)
@language
